...
import { LogOut, ArrowRight, DollarSign, Target, MessageSquare, Mail, MousePointerClick } from "lucide-react";
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-background to-muted/20">
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground font-medium">Loading donor journeys...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Donor Journey & Attribution</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              ...
              <Button variant="outline" onClick={() => navigate('/client/demographics')}>
                Demographics
              </Button>
              <ThemeToggle />

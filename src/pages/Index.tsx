...
const Index = () => {
  ...
  return (
    <PullToRefresh>
      ...
      <section className="relative pt-28 md:pt-32 pb-16 md:pb-24 overflow-hidden">
        ...
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-[720px]">
            ...
            <div className="mb-6">
              <h1 
                className="font-bebas text-[2.5rem] sm:text-[3.5rem] md:text-[4.5rem] lg:text-[5.5rem] leading-[1.05] font-black text-primary-foreground uppercase hero-headline-impact max-w-[10ch]"
                style={{ 
              ...
              <div 
                className="h-[3px] w-[120px] sm:w-[150px] md:w-[180px] bg-destructive mt-4 rounded-full animate-swipe-right"
                style={{ 
                  animationDelay: '0.6s'
                }}
              />
            ...
            >
              <div className="flex items-center gap-3 bg-primary-foreground/12 backdrop-blur-md rounded-[10px] p-3 sm:p-3.5 md:p-4 pr-4 sm:pr-5 md:pr-6 shadow-[0_6px_20px_rgba(0,0,0,0.3)] border border-primary-foreground/25 hover:scale-[1.03] hover:shadow-[0_8px_30px_rgba(20,100,217,0.4)] transition-all duration-300 group kpi-card-pulse kpi-glow-ring">
                <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-lg bg-secondary/35 backdrop-blur-sm flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                  <TrendingUp className="w-4 h-4 sm:w-5 sm:h-5 text-secondary drop-shadow-glow" />
                </div>
                <div>
              ...
              <div className="flex items-center gap-3 bg-primary-foreground/12 backdrop-blur-md rounded-[10px] p-3 sm:p-3.5 md:p-4 pr-4 sm:pr-5 md:pr-6 shadow-[0_6px_20px_rgba(0,0,0,0.3)] border border-primary-foreground/25 hover:scale-[1.03] hover:shadow-[0_8px_30px_rgba(224,45,45,0.4)] transition-all duration-300 group kpi-card-pulse kpi-glow-ring">
                <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-lg bg-destructive/35 backdrop-blur-sm flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                  <Users className="w-4 h-4 sm:w-5 sm:h-5 text-destructive drop-shadow-glow" />
                </div>
                <div>
                  <div className="font-bebas text-xl sm:text-2xl md:text-3xl text-primary-foreground leading-none">
              ...
              <div className="flex items-center gap-3 bg-primary-foreground/12 backdrop-blur-md rounded-[10px] p-3 sm:p-3.5 md:p-4 pr-4 sm:pr-5 md:pr-6 shadow-[0_6px_20px_rgba(0,0,0,0.3)] border border-primary-foreground/25 hover:scale-[1.03] hover:shadow-[0_8px_30px_rgba(244,196,48,0.4)] transition-all duration-300 group kpi-card-pulse kpi-glow-ring">
                <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-lg bg-accent/35 backdrop-blur-sm flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                  <Target className="w-4 h-4 sm:w-5 sm:h-5 text-accent-foreground drop-shadow-glow" />
                </div>
                <div>
              ...
              <div className="overflow-hidden relative mt-4">
                <div className="flex gap-4 animate-scroll-left">
                  {['Unity & Justice Fund', 'Abdul for U.S. Senate', 'Nasser for Michigan', 'Preston For PA', 'Rashid for Illinois', 'CAIR Action', 'MPAC', 'The Truth Project', 'A New Policy'].map((campaign, i) => (
                    <div 
                      key={i} 
                      className="flex-shrink-0 bg-primary-foreground/5 backdrop-blur-sm px-4 sm:px-5 md:px-6 py-2 sm:py-2.5 md:py-3 rounded-lg border border-primary-foreground/10 text-primary-foreground/60 text-xs sm:text-sm font-semibold uppercase tracking-wide whitespace-nowrap"
                    >
                      {campaign}
                    </div>
                  ))}
      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-32 bg-background relative">
        <div ref={howWeWin.ref} className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-10 md:gap-12">
            {[
              ...
              >
                <CardContent className="p-6 sm:p-7 md:p-8 lg:p-10 relative">
                  <div className="absolute top-4 right-4 font-bebas text-6xl sm:text-6xl md:text-7xl text-secondary/8 group-hover:text-secondary/15 transition-colors duration-500">
                    {step.step}
                  </div>
                  <step.icon className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 text-secondary mb-6 relative z-10 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300" />
                  <h3 className="font-bebas text-2xl sm:text-2xl md:text-3xl mb-4 text-foreground uppercase tracking-wide relative z-10">
                    {step.title}
                  </h3>
                  <p className="text-muted-foreground relative z-10 leading-relaxed text-sm sm:text-base">
                    {step.description}
                  </p>
                </CardContent>
              </Card>
      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-28 bg-gradient-to-br from-muted via-background to-muted relative">
      ...
      <section ref={metricsSection.ref} className="py-12 sm:py-14 md:py-16 lg:py-28 bg-gradient-to-br from-muted via-background to-muted relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 md:gap-6 lg:gap-8 max-w-6xl mx-auto">
            {metrics.map((metric, index) => (
              <div 
                key={index} 
                className={`group relative text-center bg-gradient-to-br from-card via-card to-muted border-2 border-secondary/20 p-6 sm:p-7 md:p-8 lg:p-10 rounded-2xl hover:border-secondary hover:scale-105 transition-all duration-700 shadow-lg hover:shadow-2xl ${
                  metricsSection.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                }`}
                style={{ 
                  transitionDelay: `${index * 150}ms`,

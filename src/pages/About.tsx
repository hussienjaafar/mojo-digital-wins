        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-[680px] space-y-6">
            ...
            <p className="text-primary-foreground/90 leading-relaxed" style={{ fontSize: 'clamp(1.125rem, 2vw, 1.25rem)' }}>
              We're not just another digital agency. We're organizers, strategists, and believers in progressive change who happen to be really good at digital marketing.
            </p>
          </div>
        </div>
      </section>

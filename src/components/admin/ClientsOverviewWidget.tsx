...
export function ClientsOverviewWidget({ showDragHandle }: Props) {
  ...
  return (
    <div className="portal-card portal-widget-blue h-full flex flex-col">
      <div className={`p-4 border-b border-[hsl(var(--portal-border))] portal-widget-header-blue ${showDragHandle ? 'cursor-move' : ''}`}>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            {showDragHandle && (
              <GripVertical className="h-5 w-5 portal-text-secondary" />
            )}
            <div className="portal-widget-icon portal-widget-icon-blue">

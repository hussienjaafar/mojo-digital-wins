...
const DialogPortal = ({ children, ...props }: DialogPrimitive.DialogPortalProps) => (
  <DialogPrimitive.Portal container={getFloatingPortalContainer()} {...props}>
    {children}
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description ref={ref} className={cn("text-sm text-[hsl(var(--portal-text-secondary))]", className)} {...props} />
));

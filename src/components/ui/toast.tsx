...
const toastVariants = cva(
  ...
  ),
  {
    variants: {
      variant: {
        default: "bg-[hsl(var(--portal-bg-secondary))] text-[hsl(var(--portal-text-primary))] border border-[hsl(var(--portal-border))]",
        destructive: "bg-[hsl(var(--portal-error))] text-white border border-[hsl(var(--portal-error))]",
      },
    },
    defaultVariants: {
      variant: "default",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ...
    className={cn(
      ...
      "border-[hsl(var(--portal-border))] bg-transparent hover:bg-[hsl(var(--portal-bg-hover))]",
      "focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
      "group-[.destructive]:border-white/40 group-[.destructive]:hover:border-white/60 group-[.destructive]:hover:bg-white/10 group-[.destructive]:focus:ring-white",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ...
    className={cn(
      ...
      "text-[hsl(var(--portal-text-secondary))] hover:text-[hsl(var(--portal-text-primary))]",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Title ref={ref} className={cn("text-sm font-semibold text-[hsl(var(--portal-text-primary))]", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Description ref={ref} className={cn("text-sm text-[hsl(var(--portal-text-secondary))]", className)} {...props} />
));

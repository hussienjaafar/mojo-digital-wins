...
export const handlers = [
  ...
  // -------------------------------------------------------------------------
  // Retired RPCs: get_actblue_daily_rollup, get_actblue_period_summary,
  // and get_actblue_filtered_rollup have been consolidated into
  // get_actblue_dashboard_metrics (mocked above).
  // -------------------------------------------------------------------------
];

...
export const mockVoterImpactStates: VoterImpactState[] = [
  ...
  },
  {
    ...
    vote_2022_pct: 0.60,
    political_donors: 25,
    political_activists: 8,
  },
  // Test state for null election data district
  {
    id: 'state-ts',
    state_code: 'TS',
    ...
    vote_2022: 0,
    vote_2022_pct: 0,
    political_donors: 100,
    political_activists: 25,
  },
];
...
export const mockVoterImpactDistricts: VoterImpactDistrict[] = [
  ...
  // At-large district (single district state)
  {
    ...
    state_code: 'WY',
    district_num: 0,
    winner: 'Harriet Hageman',
    winner_party: 'R',
    winner_votes: 185000,
    runner_up: 'Kyle Cameron',
    runner_up_party: 'D',
    runner_up_votes: 45000,
    margin_votes: 140000,
    margin_pct: 0.609,
    total_votes: 230000,
    muslim_voters: 500,
    muslim_registered: 450,
    muslim_unregistered: 50,
    voted_2024: 315,
    didnt_vote_2024: 135,
    turnout_pct: 0.70,
    can_impact: false,
  ...
  // District with no election data
  {
    ...
    total_votes: null,
    muslim_voters: 15000,
    muslim_registered: 13500,
    muslim_unregistered: 1500,
    voted_2024: 0,
    didnt_vote_2024: 13500,
    turnout_pct: 0,
    can_impact: false,
    votes_needed: null,
    cost_estimate: null,

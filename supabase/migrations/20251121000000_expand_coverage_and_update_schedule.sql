...
SET
  ...
  description = 'Fetch articles from all configured RSS feeds (every 5 minutes)',
  updated_at = now()
...
'Scheduled job registry for automated tasks. RSS Feed Sync runs every 5 minutes to ensure real-time coverage.';

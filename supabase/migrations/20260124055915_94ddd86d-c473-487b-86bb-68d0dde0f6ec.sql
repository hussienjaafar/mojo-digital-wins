-- Drop existing functions first, then recreate with new defaults
...
-- Recreate get_actblue_daily_rollup with p_use_utc defaulting to FALSE (ET = ActBlue)
...
-- Recreate get_actblue_period_summary with p_use_utc defaulting to FALSE
...
-- Recreate get_actblue_filtered_rollup with p_use_utc defaulting to FALSE

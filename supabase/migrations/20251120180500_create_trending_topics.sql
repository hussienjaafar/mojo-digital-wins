...
CREATE INDEX idx_trending_topics_timestamp ON trending_topics(hour_timestamp DESC);
CREATE INDEX idx_trending_topics_date ON trending_topics(day_date DESC);
...
-- Comment on table
COMMENT ON TABLE trending_topics IS 'AI-extracted trending topics with velocity tracking for real-time trend detection';
